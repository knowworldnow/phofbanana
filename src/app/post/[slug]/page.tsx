      ...
      <div className="container mx-auto px-4 py-8 pl-12 sm:pl-16">
        <div className="flex flex-col lg:flex-row lg:space-x-8">
          <article className="lg:w-2/3">
            {post.featuredImage && (
              <div className="relative w-full max-w-3xl mx-auto mb-8 hidden sm:block border border-red-500">
                ...
                <p className="text-xs text-red-500 mt-2">Featured Image (Debug)</p>
              </div>
            )}
            <PostHeader
              title={post.title}
